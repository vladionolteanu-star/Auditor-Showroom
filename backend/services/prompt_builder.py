"""Audit prompt builder — ported from services/prompt.ts."""

from backend.models.schemas import ZoneType
...
def build_audit_prompt(zone_type: ZoneType) -> str:
    zone_name = "Casierie" if zone_type == ZoneType.CASIERIE else "Birou Consilier"
    criteria = _CASIERIE_CRITERIA if zone_type == ZoneType.CASIERIE else _BIROU_CONSILIER_CRITERIA
